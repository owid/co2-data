...
class TestMakeDataset(unittest.TestCase):
    ...
    def test_column_names_no_whitespace(self):
        ...
        msg = ("Columns should not contain whitespace, but the following "
    ...
    def test_column_names_all_lowercase(self):
        ...
        msg = ("Columns should not uppercase characters, but the following "
    ...
    def test_no_nan_rows(self):
        ...
        msg = ("All rows should contain at least one non-NaN value, but "
